...
class TwitchSDK
{
	 ...
	 * @throws  \ritero\SDK\TwitchTV\TwitchException
	 */
	private function request($uri, $method = 'GET', $postfields = null, $additionalHeaders = array())
	{
		$params = ['CURLOPT_SSL_VERIFYPEER'];
		return $this->generalRequest($params, self::URL_TWITCH . $uri, $method, $postfields, $additionalHeaders);
	}
	 ...
	 * @throws  \ritero\SDK\TwitchTV\TwitchException
	 */
	private function generalRequest($params, $uri, $method = 'GET', $postfields = null, $additionalHeaders = array())
	{
		$this->http_info = array();
		$defaultHeaders = array('Expect:', 'Client-ID: ' . $this->getClientId());
